...
def create_choropleth_map(neighborhoods_geojson, data, city):#, city_centers, neighborhoods_geojson):        
...
if not df.empty and neighborhoods_geojson:
    ...
    if is_show_map:
        choropleth_map_fig = create_choropleth_map(neighborhoods_geojson, df,selected_city)
